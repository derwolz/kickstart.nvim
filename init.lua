...
require("lazy").setup({
	...
	-- Add this block inside your lazy setup list
	{
	...
	}, --
	{
		...
		-- This "event" makes it autostart specifically for markdown files
		ft = { "markdown" },
...
-- Automatically start ZenMode when opening a Markdown file
vim.api.nvim_create_autocmd("FileType", {
	pattern = "markdown",
	callback = function()
		vim.cmd("ZenMode")
